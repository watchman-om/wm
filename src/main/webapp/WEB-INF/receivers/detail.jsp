                        ...
                        <div class="block">
                            ...
                            <div class="block-title">
                                <div class="block-options pull-right">
                                    <a href="javascript:void(0)" class="btn btn-alt btn-sm btn-default" data-toggle="tooltip" title="수정"><i class="fa fa-cog"></i></a>
                                </div>
                                <h2>수신자 상세</h2>
                            </div>
                            <!-- END Example Title -->
                            ...
                            <div class="widget">
	                            <div class="widget-simple themed-background-autumn">
	                                <a href="page_ready_user_profile.html">
	                                    <img src="img/placeholders/avatars/avatar15.jpg" alt="avatar" class="widget-image img-circle pull-left">
	                                </a>
	                                <h4 class="widget-content widget-content-light">
	                                    <a href="page_ready_user_profile.html" class="themed-color-dark-autumn">
	                                        <strong>이승훈</strong>
	                                    </a>
	                                    <small>@카카오톡ID</small>
	                                </h4>
	                                ...
	                                <div class="row text-center">
	                                    <div class="col-xs-4">
	                                        <h3 class="widget-content-light">
	                                            <a href="javascript:void(0)" class="themed-color-autumn"><strong>150</strong></a><br>
	                                            <small>이번달 수리량</small>
	                                        </h3>
	                                    </div>
	                                    <div class="col-xs-4">
