                    ...
                    <div id="page-content">
                        ...
                        <div class="block">
	                        ...
	                        <form action="add" method="post" class="form-horizontal form-bordered">
	                            ...
	                            <div class="form-group">
	                                <label class="col-md-3 control-label" for="KAKAO_ACCOUNT">점검</label>
	                                <div class="col-md-9">
	                                    <input type="text" id="KAKAO_ACCOUNT" name="KAKAO_ACCOUNT" class="form-control" placeholder="점검">
	                                </div>
	                            </div>
	                            <div class="form-group">
	                                <label class="col-md-3 control-label" for="KAKAO_ACCOUNT">설명</label>
	                                <div class="col-md-9">
	                                    <input type="text" id="KAKAO_ACCOUNT" name="KAKAO_ACCOUNT" class="form-control" placeholder="설명">
	                                </div>
	                            </div>
