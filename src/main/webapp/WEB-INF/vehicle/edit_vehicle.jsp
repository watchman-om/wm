                        ...
                        <div class="block">
	                        ...
	                        <form action="edit" method="post" class="form-horizontal form-bordered">
	                            ...
	                            <div class="form-group">
	                                ...
	                                <div class="col-md-9">
	                                    <input type="text" id="KAKAO_ACCOUNT" name="KAKAO_ACCOUNT" class="form-control" placeholder="고객명">
	                                </div>
	                            </div>
	                            <div class="form-group">
	                                <label class="col-md-3 control-label" for="KAKAO_ACCOUNT">연락처</label>
	                                <div class="col-md-9">
	                                    <input type="text" id="KAKAO_ACCOUNT" name="KAKAO_ACCOUNT" class="form-control" placeholder="연락처">
	                                </div>
	                            </div>
	                            <div class="form-group">
